...
const newsItemsData = [
  ...
  {
    id: 2,
    title: "Congratulations to Prof. Xiaowen Zhang for receiving the Google CyberFirst grant!",
    date: "January 2024",
  },
  {
    id: 3,
  ...
  {
    id: 4,
    title: "Congratulations to Professor Sarah Zelikovitz for receiving the Dolphin Award for Outstanding Teaching!!",
    date: "October 2023",
  },
  {
    id: 5,
  ...
  {
    id: 6,
    title: "Congratulations to Prof S. Alapati for being elected as a new Academia Europaea (AE) member!!!",
    date: "June 2022",
  },
]
...
const Home = () => {
  ...
  return (
    <div className="w-full bg-white">
          ...
          <div className="max-w-2xl mx-auto flex flex-col items-center gap-8 md:gap-10 text-center">
            <div className="w-full flex flex-col gap-4">
              ...
              <p className="font-normal text-base md:text-lg leading-relaxed text-gray-800 text-balance">
                Follow us on an inward-bound journey into the world of computer science and raise them until to explore
                the art.
              </p>
            </div>
            <button
        ...
        <div className="w-full max-w-6xl flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            ...
            <p className="font-normal text-base md:text-lg leading-relaxed text-gray-800">
              The Computer Science Department offers programs that prepare students for careers in computer science
              and/or for continued study in the discipline at the graduate level. The major provides a broad background
              in computer science and includes courses in programming, computer organization, information systems,
              software engineering and various areas of computer hardware. We are committed to offering courses that
              stay current with changing technologies. All as a Computer Science degree is accredited.
            </p>
          </div>
        ...
        <div className="w-full max-w-6xl flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-16">
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            ...
            <address className="flex flex-col gap-4 not-italic">
              <div>
                <p className="font-bold text-xl md:text-2xl text-gray-950">Professor Shuqun Zhang</p>
                <p className="font-normal italic text-base text-gray-800">Chairperson of the Department</p>
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="font-normal text-base text-gray-800">Fax: 718.982-2856</p>
              </div>
            </address>
          </div>
                ...
                {degreeLinks.map((link, index) => (
                  <div key={index} className="flex items-center gap-2">
                    ...
                    {index < degreeLinks.length - 1 && (
                      <span className="font-normal text-sm md:text-base text-gray-700" aria-hidden="true">
                        ・
                      </span>
                    )}
                  </div>
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <article className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition focus-within:ring-2 focus-within:ring-blue-600">
              ...
              <div className="p-4 md:p-6 flex flex-col gap-2">
                <h3 className="font-semibold text-xl md:text-2xl leading-tight text-gray-950">BS Specializations</h3>
                <p className="font-normal text-base text-gray-800">
                  Game Development
                  <br />
      ...
      {/* News Section */}
      <section className="w-full bg-white py-12 md:py-20 px-4 md:px-8 lg:px-10" aria-label="Latest News">
        <div className="w-full max-w-6xl mx-auto flex flex-col items-center gap-8 md:gap-12">
          ...
          <div className="w-full flex flex-col items-center gap-3 text-center">
            ...
            <p className="font-normal text-lg md:text-xl leading-relaxed text-gray-800 text-balance">
              Stay up to date with achievements, breakthroughs in computer science, and latest research
            </p>
          </div>
          ...
          <div className="w-full flex flex-col items-center gap-6 md:gap-8">
            ...
            {/* Accordion */}
            <div className="w-full flex flex-col" role="region" aria-label="News articles">
              {filteredNews.map((item) => (
                <article key={item.id} className="w-full flex flex-col border-b border-gray-600">
                  <div className="flex items-start gap-3 py-4">
                    <div className="flex-grow flex flex-col gap-2">
                      ...
                      {expandedItems.includes(item.id) && item.description && (
                        <>
                          <p className="font-normal text-base leading-relaxed text-gray-800">{item.description}</p>
                          <p className="font-bold text-base md:text-lg leading-relaxed text-gray-700">{item.date}</p>
                        </>
                      )}
                      {!expandedItems.includes(item.id) && (
                        <p className="font-normal text-sm text-gray-700">{item.date}</p>
                      )}
                    </div>
                    <button
              ...
              {filteredNews.length === 0 && (
                <div className="w-full py-8 text-center">
                  <p className="font-normal text-base text-gray-800">No news items match your search.</p>
                </div>
              )}
            </div>
          </div>
