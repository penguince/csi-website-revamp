...
const facultyData = [
  {
    ...
    image: "https://placehold.co/600x400/9ec0af/1e293b?text=Computational+Vision",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    image: "https://placehold.co/600x400/9ec0af/1e293b?text=Software+Engineering",
  },
]
...
const studentProjects = [
  {
    ...
    project: "Best Presentation Award at LaGuardia CRISP Symposium - Implementation of ML models for medical imaging",
  },
  { name: "Student Name", project: "Real-Time Object Detection using YOLO and Transfer Learning" },
  { name: "Student Name", project: "Secure Blockchain-Based Data Storage System" },
  { name: "Student Name", project: "Advanced NLP Chatbot for Customer Service" },
  { name: "Student Name", project: "Mobile App Development with Flutter and Firebase" },
  { name: "Student Name", project: "Distributed System Architecture for Cloud Computing" },
  { name: "Student Name", project: "Quantum Computing Algorithm Implementation" },
  { name: "Student Name", project: "IoT Sensor Network for Environmental Monitoring" },
]
    ...
    <div className="w-full bg-white overflow-x-hidden">
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row gap-6 lg:gap-8 p-4 sm:p-6 md:p-8 lg:p-12">
        ...
        <main className="w-full lg:flex-1 flex flex-col gap-8 md:gap-12 order-1 lg:order-2 overflow-x-hidden">
              ...
              {covidProjects.map((project) => (
                ...
                >
                  <div className="bg-white p-4 md:p-6 h-full flex flex-col">
                    <h3 className="font-bold text-lg md:text-xl text-gray-950 mb-3 line-clamp-2">{project.title}</h3>
          ...
          <section aria-label="Faculty Research" className="overflow-x-hidden">
            <div className="flex flex-col gap-4 md:gap-6 mb-6 overflow-x-hidden">
              ...
              <p className="text-sm text-gray-600" aria-live="polite">
                {filteredFaculty.length} research area{filteredFaculty.length !== 1 ? "s" : ""} found
              </p>
            </div>
              ...
              {filteredFaculty.map((item) => (
                ...
                >
                  ...
                  <div className="p-4 md:p-6 flex flex-col gap-4 h-full min-w-0">
                    ...
                    >
                      {expandedSections.includes(item.id) ? "Read less <" : "Read more >"}
                    </button>
                  </div>
                </article>
              ))}
            ...
            {filteredFaculty.length === 0 && (
              <div className="text-center py-8">
                <p className="text-gray-800 text-base">No research items match your search.</p>
              </div>
            )}
          </section>
          ...
          <section aria-label="Student Research" className="bg-white py-6 md:py-8 overflow-x-hidden">
              ...
              <div className="w-full lg:flex-1 flex flex-col gap-6 min-w-0">
                ...
                <div className="flex flex-col gap-4 overflow-x-hidden">
                  {studentProjects.map((student, index) => (
                    ...
                    >
                      <span className="text-blue-600 font-semibold flex-shrink-0">{student.name}</span>
                      <span className="text-gray-800 flex-shrink-0" aria-hidden="true">
                        -
                      </span>
                      <span className="text-gray-800 break-words min-w-0">{student.project}</span>
                    </div>
                  ))}
                  <a
                    href="#"
