...
import { Facebook, Instagram, Linkedin, MapPin, Phone, Twitter, Youtube } from "lucide-react"
        ...
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-20 mb-8 md:mb-10">
          <div className="flex flex-col gap-6 md:gap-8 w-full lg:w-auto lg:flex-shrink-0">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-start gap-3 py-2 min-h-11">
                <MapPin className="w-5 h-5 md:w-6 md:h-6 text-blue-300 flex-shrink-0 mt-0.5" aria-hidden="true" />
                <p className="text-white text-sm md:text-base leading-relaxed">Transportation: Directions, Parking</p>
              </div>
              ...
              {/* Phone */}
              <div className="flex items-start gap-3 py-2 min-h-11">
                <Phone className="w-5 h-5 md:w-6 md:h-6 text-blue-300 flex-shrink-0 mt-0.5" aria-hidden="true" />
                <a
          ...
          <div className="flex flex-col sm:flex-row gap-8 md:gap-12 lg:gap-16 w-full lg:flex-1">
            ...
            <div className="flex flex-col w-full sm:flex-1">
              <h3 className="text-blue-300 font-bold text-base md:text-lg leading-6 pb-4 md:pb-6">Connect With Us</h3>
            ...
            {/* Legal Column */}
            <div className="flex flex-col w-full sm:flex-1">
              <h3 className="text-blue-300 font-bold text-base md:text-lg leading-6 pb-4 md:pb-6">Legal</h3>
              <ul className="flex flex-col gap-2">
                {legalLinks.map((link) => (
                  <li key={link.name}>
                    <a
